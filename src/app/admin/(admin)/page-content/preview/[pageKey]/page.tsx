"use client"; // tambahkan ini paling atas agar component jalan di client
...
export default function PreviewPage({ params }: PreviewPageProps) {
  ...
  // State untuk menampung data final yang akan di-render
  ...
  useEffect(() => {
    async function fetchData() {
      // Ambil data dari DB dulu (server action)
      ...
      if (!dbContent) {
        ...
        newContent = {
          ...
          createdAt:
            typeof dbContent.createdAt === "string"
              ? dbContent.createdAt
              : dbContent.createdAt.toISOString(),
          updatedAt:
            typeof dbContent.updatedAt === "string"
              ? dbContent.updatedAt
              : dbContent.updatedAt.toISOString(),
        };
      }

      // Coba override dengan data sessionStorage (jika ada)
      const previewData = sessionStorage.getItem("pageContentPreview");
      if (previewData) {
        const parsedData = JSON.parse(previewData);
        // Pastikan pageKey-nya sama dengan yang sedang diakses
  ...
  const pageLabel =
    PAGE_KEY_LABELS[pageKey] || pageKey.replace(/_/g, " ");
            ...
            <CardContent className="space-y-3">
              ...
              <div>
                ...
                <div className="mt-1">
                  <Badge
                    variant={
                      pageContent.isActive ? "default" : "secondary"
                    }
                  >
